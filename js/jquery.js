...
(function (global, factory) {
  ...
  var Sizzle =
    ...
    (function (window) {
      ...
      function createButtonPseudo(type) {
        return function (elem) {
          var name = elem.nodeName.toLowerCase();
          return (name === "input" || name === "button") && elem
            .type === type;
        };
      }
      /**
      ...
      setDocument = Sizzle.setDocument = function (node) {
        ...
        if (doc === document || doc.nodeType !== 9 || !doc
          .documentElement) {
          return document;
        }
        // Set our document
        ...
        // Support: IE<9
        support.getElementsByClassName = rnative.test(doc
        ...
        rbuggyMatches = rbuggyMatches.length && new RegExp(rbuggyMatches
          .join("|"));
        /* Contains
        ---------------------------------------------------------------------- */
        ...
        contains = hasCompare || rnative.test(docElem.contains) ?
          function (a, b) {
            ...
            return a === bup || !!(bup && bup.nodeType === 1 && (
              ...
              .compareDocumentPosition(bup) & 16
            ));
          } :
          function (a, b) {
            if (b) {
      ...
      getText = Sizzle.getText = function (elem) {
        ...
        if (!nodeType) {
          ...
          if (typeof elem.textContent === "string") {
            ...
            for (elem = elem.firstChild; elem; elem = elem
              .nextSibling) {
              ret += getText(elem);
            }
          }
      ...
      Expr = Sizzle.selectors = {
        ...
        pseudos: {
            ...
            return function (elem) {
              ...
              do {
                if ((elemLang = documentIsHTML ?
                    elem.lang :
                    elem.getAttribute("xml:lang") || elem
                    .getAttribute("lang"))) {
          ...
          "focus": function (elem) {
            return elem === document.activeElement && (!document
              .hasFocus || document.hasFocus()) && !!(elem.type ||
      ...
      function setMatcher(preFilter, selector, matcher, postFilter,
        ...
        return markFunction(function (seed, results, context, xml) {
          var temp, i, elem,
            ...
            elems = seed || multipleContexts(selector || "*", context
      ...
      function matcherFromTokens(tokens) {
        ...
        for (; i < len; i++) {
          if ((matcher = Expr.relative[tokens[i].type])) {
            ...
            matcher = Expr.filter[tokens[i].type].apply(null, tokens[i]
              .matches);
  ...
  jQuery.fn.extend({
    ...
    closest: function (selectors, context) {
      var cur,
        ...
        0;
      for (; i < l; i++) {
        for (cur = this[i]; cur && cur !== context; cur = cur
          .parentNode) {
  ...
  jQuery.each({
    ...
    contents: function (elem) {
      return elem.contentDocument || jQuery.merge([], elem
      .childNodes);
    }
  }, function (name, fn) {
  ...
  jQuery.Callbacks = function (options) {
    ...
    var // Last fire value (for non-forgettable lists)
      ...
      self = {
        ...
        has: function (fn) {
          return fn ? jQuery.inArray(fn, list) > -1 : !!(list && list
            .length);
        },
          ...
          then: function ( /* fnDone, fnFail, fnProgress */ ) {
            ...
            return jQuery.Deferred(function (newDefer) {
              jQuery.each(tuples, function (i, tuple) {
                var fn = jQuery.isFunction(fns[i]) && fns[
                i];
  ...
  jQuery.acceptData = function (owner) {
    ...
    //    - Any
    /* jshint -W018 */
    return owner.nodeType === 1 || owner.nodeType === 9 || !(+owner
      .nodeType);
  };
  ...
  var isHidden = function (elem, el) {
    ...
    elem = el || elem;
    return jQuery.css(elem, "display") === "none" || !jQuery.contains(elem
      .ownerDocument, elem);
  };
  ...
  jQuery.event = {
    ...
    trigger: function (event, data, elem, onlyHandlers) {
      ...
      if (!onlyHandlers && !event.isDefaultPrevented()) {
        if ((!special._default || special._default.apply(eventPath
          ...
          if (ontype && jQuery.isFunction(elem[type]) && !jQuery
            .isWindow(elem)) {
    ...
    dispatch: function (event) {
      ...
      while ((matched = handlerQueue[i++]) && !event
        ...
        while ((handleObj = matched.handlers[j++]) && !event
          ...
          if (!event.namespace_re || event.namespace_re.test(handleObj
              .namespace)) {
    ...
    handlers: function (event, handlers) {
      ...
      if (delegateCount && cur.nodeType && (!event.button || event
          .type !== "click")) {
    ...
    fix: function (event) {
      ...
      copy = fixHook.props ? this.props.concat(fixHook.props) : this
        .props;
    ...
    off: function (types, selector, fn) {
      ...
      if (types && types.preventDefault && types.handleObj) {
        ...
        jQuery(types.delegateTarget).off(
          handleObj.namespace ? handleObj.origType + "." + handleObj
          ...
          if (hasScripts) {
            ...
            for (i = 0; i < hasScripts; i++) {
              ...
              if (rscriptType.test(node.type || "") &&
                !data_priv.access(node, "globalEval") && jQuery
                .contains(doc, node)) {
                if (node.src) {
    ...
    if (!display) {
      ...
      if (display === "none" || !display) {
        ...
        iframe = (iframe || jQuery(
          "<iframe frameborder='0' width='0' height='0'/>")).appendTo(doc
          .documentElement);
    ...
    if (window.getComputedStyle) {
      jQuery.extend(support, {
        ...
        reliableMarginRight: function () {
          ...
          div.style.width = "1px";
          docElem.appendChild(container);
          ret = !parseFloat(window.getComputedStyle(marginDiv, null)
            .marginRight);
          docElem.removeChild(container);
  ...
  jQuery.extend({
    ...
    style: function (elem, name, value, extra) {
      ...
      if (!elem || elem.nodeType === 3 || elem.nodeType === 8 || !elem
        .style) {
        return;
      }
  ...
  Tween.propHooks = {
    _default: {
      ...
      set: function (tween) {
        ...
        } else if (tween.elem.style && (tween.elem.style[jQuery
            .cssProps[tween.prop]] != null || jQuery.cssHooks[tween
            .prop])) {
      ...
      animation = deferred.promise({
        ...
        createTween: function (prop, end) {
          var tween = jQuery.Tween(elem, animation.opts, prop, end,
            animation.opts.specialEasing[prop] || animation.opts
            .easing);
  ...
  jQuery.extend({
    ...
    propHooks: {
      tabIndex: {
        get: function (elem) {
          return elem.hasAttribute("tabindex") || rfocusable.test(elem
              .nodeName) || elem.href ?
            elem.tabIndex :
            -1;
        }
    ...
    toggleClass: function (value, stateVal) {
      ...
      if (jQuery.isFunction(value)) {
        return this.each(function (i) {
          jQuery(this).toggleClass(value.call(this, i, this
  ...
  jQuery.fn.extend({
    val: function (value) {
      ...
      if (!arguments.length) {
        if (elem) {
          hooks = jQuery.valHooks[elem.type] || jQuery.valHooks[elem
      ...
      return this.each(function (i) {
        ...
        hooks = jQuery.valHooks[this.type] || jQuery.valHooks[this
          .nodeName.toLowerCase()];
  ...
  jQuery.extend({
    ...
    ajax: function (url, options) {
            ...
            if (state === 2) {
              if (!responseHeaders) {
                ...
                while ((match = rheaders.exec(
                    responseHeadersString))) {
                  responseHeaders[match[1].toLowerCase()] = match[
                  2];
                }
              }
      ...
      if (!s.hasContent) {
        ...
        if (s.data) {
          cacheURL = (s.url += (rquery.test(cacheURL) ? "&" : "?") + s
            .data);
      ...
      if (s.ifModified) {
        if (jQuery.lastModified[cacheURL]) {
          jqXHR.setRequestHeader("If-Modified-Since", jQuery
      ...
      if (s.data && s.hasContent && s.contentType !== false || options
        .contentType) {
      ...
      return this.map(function () {
        ...
        .filter(function () {
          ...
          return this.name && !jQuery(this).is(":disabled") &&
            rsubmittable.test(this.nodeName) && !rsubmitterTypes
            .test(type) &&
      ...
      return {
        send: function (headers, complete) {
          var i,
            xhr = options.xhr(),
            id = ++xhrId;
          xhr.open(options.type, options.url, options.async, options
        ...
        send: function (_, complete) {
          script = jQuery("<script>").prop({
            ...
            callback = function (evt) {
              ...
              callback = null;
              if (evt) {
                complete(evt.type === "error" ? 404 : 200, evt
                .type);
              }
            }
          );
  ...
  jQuery.ajaxPrefilter("json jsonp", function (s, originalSettings, jqXHR) {
    ...
    if (jsonProp || s.dataTypes[0] === "jsonp") {
      ...
      callbackName = s.jsonpCallback = jQuery.isFunction(s
          .jsonpCallback) ?
        s.jsonpCallback() :
        s.jsonpCallback;
  ...
  function getWindow(elem) {
    return jQuery.isWindow(elem) ? elem : elem.nodeType === 9 && elem
      .defaultView;
  }
  jQuery.offset = {
